...
do
    python -u run_longExp.py \
      ...
      --model_id $model_id_name'_MS_sl'$seq_len'_pl'$pred_len \
      --model $model_name \
      --data $data_name \
      --features MS \
      --target system_price \
    ...
    --plot_features "$plot_features" \
      ...
      --pct_start 0.2 \
      --loss_flag 2 \
      --itr 1 --batch_size 256 --learning_rate 0.0001 >logs/LongForecasting/$model_name'_fMS_'$model_id_name'_sl'$seq_len'_pl'$pred_len'_seed'$random_seed.log
done
